...
@section('content')
    ...
    <div class="row">
        ...
        {{-- <div class="modal fade commandModal" data-keyboard="false" data-backdrop="static" role="dialog">
                ...
                <form id="modalForm">
                    ...
                    <div class="modal-title d-flex justify-content-left p-2">
                        ...
                        <div class="d-flex mr-auto d-none" id="title">
                            ...
                            <input type="text" id="titleInput" class="form-control d-none">
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <textarea class="form-control d-none" id="command"></textarea>
                        </div>
